...
public class HeaderServerInterceptor implements ServerInterceptor {
    ...
    public static class InterceptServerCall<ReqT, RespT> extends SimpleForwardingServerCall<ReqT, RespT> {
        public InterceptServerCall(ServerCall<ReqT, RespT> delegate) {
            super(delegate);
        }
